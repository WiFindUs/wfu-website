             ...
             <?php if( $smof_data['rnr_enable_googlemap']) { ?>          
              <div  class="row contact-map">
                      ...
                      function initialize() {
                              ...
                              boxText.innerHTML = '<div class="captionMap animated bounceInDown"><img src="<?php echo $smof_data['rnr_map_logo']; ?>" class="alignleft"  alt="Contact Address"> <span><?php $contact_address = $smof_data['rnr_contact_address']; echo  htmlentities($contact_address); ?></span></div>';
