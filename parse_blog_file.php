...
//$articleIdentifier = "article".$_POST['firstname'];
	...
	for($i = 0; $i<$numImages; $i++)
	{
		...
		if($numImages < 3)
		{
			...
			echo "</a>";
					...
					echo "<div id = \"imageOverlay\" onclick=\"location.href='#close';\">&nbsp</div>";
									...
									else // is a next image
									{
										echo " <div id='nextBtnContainer'>";
											echo "<a href=\"#".$articleNum."_fullsize_image_".$nextImage."\">";
												echo "<input id=\"nextImageBtn\" type=\"image\" src=\"images/next_image_arrow.png\" >";
											echo "</a>";
											echo "<a href=\"#close\" title=\"Close\" class=\"close\">X</a>";     
										echo "</div>";
									}
								...
								else //prev image
								{
									echo " <div id='prevBtnContainer'>";
										echo "<a href=\"#".$articleNum."_fullsize_image_".$prevImage."\">";
											echo "<input id=\"prevImageBtn\" type=\"image\" src=\"images/next_image_arrow.png\" >	";
										echo "</a>";   
									echo "</div>";
									if($imageCount+1 == $numImages) //no next image
									{
